...
public class Client {
	...
	/**
	 * Ask the web service if the user have enough money to buy the book,
	 * the money is converted to the correct currency if needed with the converter web service
	...
	/**
	 * Action of buying the book, withdraw money and remove some exemplary of the book
